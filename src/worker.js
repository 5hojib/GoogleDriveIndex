...
const crypto_base_key = "a4affcad11ea4c7f696e63edaf92095e"
const encrypt_iv = new Uint8Array([38,100,240,76,189,111,227,246,178,254,115,201,91,244,245,171]);
const uiConfig = {
  "theme": "united",
  "version":  "1.6",
  "logo_image": true,
  "logo_height": "",
  "logo_width": "100px",
  "favicon": "https://cdn.jsdelivr.net/gh/5hojib/googledriveindex@mlatest/images/favicon.svg",
  ...
  "fixed_footer": false,
  "hide_footer": true,
  "header_style_class": "navbar-light bg-light",
  "footer_style_class": "bg-primary",
  "css_a_tag_color": "black",
  "css_p_tag_color": "black",
  "folder_text_color": "black",
  "loading_spinner_class": "text-dark",
  "search_button_class": "btn btn-light",
  "path_nav_alert_class": "alert alert-info",
  "file_view_alert_class": "alert alert-light",
  "file_count_alert_class": "alert alert-secondary",
  "contact_link": "https://telegram.dog/JuniorXcientist",
  "copyright_year": "2050",
  "company_name": "XciKloud",
  "company_link": "https://telegram.dog/JuniorXcientist",
  "credit": false,
  "display_size": true,
  "display_time": false,
  ...
  "jsdelivr_cdn_src": "https://cdn.jsdelivr.net/gh/5hojib/GoogleDriveIndex",
  "render_head_md": true,
         ...
         <a class="navbar-brand" href="/">${uiConfig.logo_image ? '<img border="0" alt="'+uiConfig.company_name+'" src="'+uiConfig.logo_link_name+'" height="'+uiConfig.height+'" width="'+uiConfig.logo_width+'">' : uiConfig.logo_link_name}</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
               <a class="nav-link" href="${uiConfig.contact_link}" target="_blank">${uiConfig.nav_link_2}</a>
            </li>
           ...
           <form class="d-flex" method="get" action="/0:search">
            ...
            <button class="btn btn btn-light" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit">Search</button>
           </form>
          </div>
         </div>
      </nav>
